...
+ (MODAOProvider*)daoProvider {
    static MODAOProvider *instance = nil;
    if (!instance) {
        instance = [MODAOProvider providerWithDataSource:[[DemoSQLiteOpenHelper alloc] initWithDbName:@"MobiORMDemo"]];
    }
    return instance;
}

+ (PlaceManager*)placeManager {
    static PlaceManager *instance = nil;
    if (!instance) {
        instance = [[PlaceManager alloc] init];
    }
    return instance;
}
